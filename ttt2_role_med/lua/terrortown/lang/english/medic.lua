...
L[ "ttt2_role_medic_popuptitle" ] = "A medic which arrived at the field is named: "
L[ "ttt2_role_medic_popuptitle_2" ] = "The medic was killed! A war crime just happened from: "
L[ "ttt2_role_medic_popuptitle_3" ] = "The medic has done a crime! He's now an unequipped medic helping the innocent: "
L[ "ttt2_role_medic_popuptitle_4" ] = "The medic killed another medic! This is treason, kill: "
L[ "weapon_med_defi_name" ] = "Medic Defibrillator"
L[ "weapon_med_defi_desc" ] = "A high energy device to revive other players."
L[ "med_revived_by_player" ] = "You are revived by {name}. Prepare yourself!"
...
L[ "ttt2_med_medigun_help1" ] = "{primaryfire} Heal someone with a strong heal beam."
L[ "ttt2_med_medigun_help2" ] = "{secondaryfire} Use Ubercharge if it is charged to make your beam stronger."