...
L["ttt2_med_defibrillator_help1"] = "Rianima i cadaveri"
L["ttt2_med_defibrillator_help2"] = "Fai un beep sonoro"
...
L["label_med_win_rqd_heal_per_alv_ply"] = "Punti di guarigione richiesti per la vittoria (senza medici)"
